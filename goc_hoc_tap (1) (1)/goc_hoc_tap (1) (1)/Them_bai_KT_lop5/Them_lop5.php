...
<body>
    <div class="form-container">
        ...
        <form action="xuly_them_lop5.php" method="POST" enctype="multipart/form-data">
            
            <label for="subject">Chủ đề</label>
            <select id="subject" name="subject" required>
                <option value="">-- Chọn chủ đề --</option>
                <option value="Chủ đề 1: Số thập phân">Chủ đề 1: Số thập phân</option>
                <option value="Chủ đề 2: Một số đơn vị đo diện tích">Chủ đề 2: Một số đơn vị đo diện tích</option>
                <option value="Chủ đề 3: Các phép tính với số thập phân">Chủ đề 3: Các phép tính với số thập phân</option>
                <option value="Chủ đề 4: Một số hình phẳng. Chu vi và diện tích">Chủ đề 4: Một số hình phẳng. Chu vi và diện tích</option>
            </select>
