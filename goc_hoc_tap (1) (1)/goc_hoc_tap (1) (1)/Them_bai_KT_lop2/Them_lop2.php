...
<body>
    <div class="form-container">
        ...
        <form action="xuly_them_lop2.php" method="POST" enctype="multipart/form-data">
            
            <label for="subject">Chủ đề</label>
            <select id="subject" name="subject" required>
                <option value="">-- Chọn chủ đề --</option>
                <option value="Chủ đề 1: Phép cộng, phép trừ trong phạm vi 20">Chủ đề 1: Phép cộng, phép trừ trong phạm vi 20</option>
                <option value="Chủ đề 2: Làm quen với khối lượng, dung tích">Chủ đề 2: Làm quen với khối lượng, dung tích</option>
                <option value="Chủ đề 3: Phép cộng, phép trừ (có nhớ) trong phạm vi 100">Chủ đề 3: Phép cộng, phép trừ (có nhớ) trong phạm vi 100</option>
                <option value="Chủ đề 4: Làm quen với hình phẳng">Chủ đề 4: Làm quen với hình phẳng</option>
                <option value="Chủ đề 5: Ngày – giờ, giờ - phút, ngày - tháng">Chủ đề 5: Ngày – giờ, giờ - phút, ngày - tháng</option>
            </select>
