    ...
    <div class="form-container">
        ...
        <form action="xuly_them.php" method="POST" enctype="multipart/form-data">
            ...
            <select id="subject" name="subject" required>
                ...
                <option value="Chủ đề 1 : Các số từ 0 đến 10">Chủ đề 1 : Các số từ 0 đến 10</option>
                <option value="Chủ đề 2 : Làm quen với một số hình phẳng">Chủ đề 2 : Làm quen với một số hình phẳng</option>
                <option value="Chủ đề 3 : Phép cộng, phép trừ trong phạm vi 10">Chủ đề 3 : Phép cộng, phép trừ trong phạm vi 10</option>
                <option value="Chủ đề 4 : Làm quen với một số hình khối">Chủ đề 4 : Làm quen với một số hình khối</option>
            </select>
