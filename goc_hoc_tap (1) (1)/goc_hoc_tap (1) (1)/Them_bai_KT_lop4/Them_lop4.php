...
<body>
    <div class="form-container">
        ...
        <form action="xuly_them_lop4.php" method="POST" enctype="multipart/form-data">
            
            <label for="subject">Chủ đề</label>
            <select id="subject" name="subject" required>
                <option value="">-- Chọn chủ đề --</option>
                <option value="Chủ đề 1: Góc và đơn vị đo góc">Chủ đề 1: Góc và đơn vị đo góc</option>
                <option value="Chủ đề 2: Số có nhiều chữ số">Chủ đề 2: Số có nhiều chữ số</option>
                <option value="Chủ đề 3: Một số đơn vị đo đại lượng">Chủ đề 3: Một số đơn vị đo đại lượng</option>
                <option value="Chủ đề 4: Phép cộng và phép trừ">Chủ đề 4: Phép cộng và phép trừ</option>
                <option value="Chủ đề 5: Đường thẳng vuông góc. Đường thẳng song song">Chủ đề 5: Đường thẳng vuông góc. Đường thẳng song song</option>
            </select>
