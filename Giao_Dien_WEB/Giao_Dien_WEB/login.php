...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <form action="../config/dang_nhap_HS.php" method="POST">
               <a class="back" href="index.php">
                ...
                <h1>Đăng nhập</h1>               
                    <h3 class="acc"><span id="chon"><a href="login.php">Học sinh</a></span> | <a href="A_login_teacher.php">Giáo viên</a> | <a href="A_phuhuynh.php">Phụ Huynh</a></h3>
                <div class="login">
                    <div class="input-box">
                        <input type="text" class="name" id="user"  placeholder="Nhập Email hoặc Tên" name="user" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="register-link"><p><a href="A_register.php">Đăng ký tài khoản</a></p></div>
                </div>
            </form>
        </div>
    </body>
