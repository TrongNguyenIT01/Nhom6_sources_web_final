...
<html lang="en">
    ...
    <body>
        <div class="wrapper">
            <form action="../config/dang_nhap_PH.php" method="POST">
               <a  href="index.php">
                ...
                <h1>Đăng nhập</h1>
                    <h3 class="acc"><a href="login.php">Học sinh</a> | <a href="A_login_teacher.php">Giáo viên</a> | <a href="A_phuhuynh.php"><span id="chon">Phụ Huynh</span></a></h3>
               <div class="login">
                    <div class="input-box">
                        <input type="text" class="name" id="name" name="user" placeholder="Nhập Tên PH hoặc ID Phụ Huynh" required>
                    </div>
                    <div class="input-box">
