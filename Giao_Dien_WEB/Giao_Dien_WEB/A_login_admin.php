        ...
        <div class="wrapper">
            <form action="../config/dang_nhap_GV.php" method="POST">
               <a  href="index.html">
                ...
                <h1>Đăng nhập</h1>
                    <h3 class="acc"><a href="login.php">Học sinh</a> | <a href="A_login_teacher.php">Giáo viên</a> | <a href="A_phuhuynh.php">Phụ Huynh</a> | <span id="chon"><a href="A_login_admin.php">Admin</a></span></h3>
                <div class="login">
                    <div class="input-box">
                        <input type="text" class="name" id="name" name ="user" placeholder="Nhập ID" required>
                    </div>
                    <div class="input-box">
